...
MIN_TESTS = 4371  # 🔴 重釘 4246 → 4371（方向＝收緊；2026-09-19，DEF-200-274 第十四輪收尾單人窗口）：discovery 探針實測直接填入、零加減推算；成長來源＝第十～十三輪新增的 xdist／cpu_budget／哨兵 headSha 等測試類別，以及本輪 DEF-200-325～331 回歸鎖（runner 自檢「餘裕只剩 89／214」提示重釘）。歷來完整逐輪沿革（含每次重釘理由）已搬至 docs/06_quality/CrossPlatform_Guard_Line_History_MinTests.md，本行不再原地累加。
