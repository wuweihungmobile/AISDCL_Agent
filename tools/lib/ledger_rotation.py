...
OVERSIZE_ROW_CEILING_HISTORY: tuple[int, ...] = (105, 101, 98, 85, 83, 66, 63, 62)
...
_SEALED_HISTORY_PREFIXES: dict[str, tuple[int, ...]] = {
    # 帳本減半波：史料尾端追加 62，故把 63 一併封入（`_SEAL_TAIL_MAX=1` 只准留一個未封印
    # 的尾巴）。封印**只准在尾端延長**，這裡沒有改寫任何已釘過的值。
    "OVERSIZE_ROW_CEILING": (105, 101, 98, 85, 83, 66, 63),
    "OVERSIZE_ROW_EXCESS_CEILING": (
        162282, 147944, 147455, 146210, 143303, 140957, 138938, 138936, 123867,
    121758, 82896, 77186, 75047, 69122,
    ),
...
_SEAL_TABLE_SHA256 = "f860dff6e4fe5622"
