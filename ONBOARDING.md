...
> <!-- snapshot-fingerprints-win32: v001=unrecorded v030=unrecorded scripts=unrecorded autoclaude=unrecorded measured-at=unrecorded host=unrecorded docker=unrecorded pgextras=unrecorded baseline-origin=pre-provenance-mechanism ／ 同上，由 Windows 側維護。🔴 該 origin 值的語意＝**本欄的數字是 Windows 11 實機量得的，只是量測早於 R67 引入的 provenance 機制，故環境不可考**；**不是**「沒量過」（DEF-101-756）。史料見下方「Windows 欄為何整欄記 unrecorded」段 -->
>
