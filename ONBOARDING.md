...
> <!-- snapshot-fingerprints-darwin: v001=8ffe3c3dabbd v030=59a99343a6b9 scripts=90effa5613bf autoclaude=3a39fa826dcc measured-at=2026-08-15 host=Darwin-25.5.0-arm64 docker=up pgextras=absent interpreter=venv-clean/bin@3.11.15 sdk-extra=absent baseline-origin=self-recorded ／ 由 `python tools/sync_onboarding_baselines.py --write --with-slow` 在 macOS 上維護，勿手改；刪除本標記會讓 --check-snapshot fail-loud -->
