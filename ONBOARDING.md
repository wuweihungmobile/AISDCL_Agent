...
> <!-- snapshot-fingerprints-win32: v001=8ffe3c3dabbd v030=f9b73917d436 scripts=68052c079d55 autoclaude=8d96fc53ed8a measured-at=2026-08-03 host=Windows-10-AMD64 docker=up pgextras=absent baseline-origin=self-recorded ／ 同上，由 Windows 側維護。🔴 該 origin 值的語意＝**本欄的數字是 Windows 11 實機量得的，只是量測早於 R67 引入的 provenance 機制，故環境不可考**；**不是**「沒量過」（DEF-101-756）。史料見下方「Windows 欄為何整欄記 unrecorded」段 -->
>
