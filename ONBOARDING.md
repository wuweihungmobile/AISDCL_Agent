...
> <!-- snapshot-fingerprints-darwin: v001=8ffe3c3dabbd v030=a72dea28c763 scripts=e00cd1e2f6da autoclaude=ae372a0b2988 measured-at=2026-09-19 host=Darwin-25.6.0-arm64 docker=up pgextras=absent interpreter=autoclaude_cleanvenv_20260919T144504Z/bin@3.11.15 sdk-extra=present baseline-origin=self-recorded ／ 由 `python tools/sync_onboarding_baselines.py --write --with-slow` 在 macOS 上維護，勿手改；刪除本標記會讓 --check-snapshot fail-loud -->
