...
> <!-- snapshot-fingerprints-darwin: v001=8ffe3c3dabbd v030=cd2fae7923a1 scripts=645c9debe7f3 autoclaude=c11795a3a8bf measured-at=2026-09-12 host=Darwin-25.6.0-arm64 docker=down pgextras=absent interpreter=onboarding_clean_venv/bin@3.11.15 sdk-extra=present baseline-origin=self-recorded ／ 由 `python tools/sync_onboarding_baselines.py --write --with-slow` 在 macOS 上維護，勿手改；刪除本標記會讓 --check-snapshot fail-loud -->
