...
> <!-- snapshot-fingerprints-darwin: v001=8ffe3c3dabbd v030=b17718d7e776 scripts=01879e740b07 autoclaude=dbf953bd5f92 measured-at=2026-08-26 host=Darwin-25.5.0-arm64 docker=up pgextras=absent interpreter=r105-clean-venv/bin@3.11.15 sdk-extra=absent baseline-origin=self-recorded ／ 由 `python tools/sync_onboarding_baselines.py --write --with-slow` 在 macOS 上維護，勿手改；刪除本標記會讓 --check-snapshot fail-loud -->
