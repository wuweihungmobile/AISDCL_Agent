...
> <!-- snapshot-fingerprints-darwin: v001=8ffe3c3dabbd v030=b17718d7e776 scripts=01879e740b07 autoclaude=e5cddef60507 measured-at=2026-08-27 host=Darwin-25.5.0-arm64 docker=up pgextras=absent interpreter=r107-clean-venv/bin@3.11.15 sdk-extra=absent baseline-origin=self-recorded ／ 由 `python tools/sync_onboarding_baselines.py --write --with-slow` 在 macOS 上維護，勿手改；刪除本標記會讓 --check-snapshot fail-loud -->
