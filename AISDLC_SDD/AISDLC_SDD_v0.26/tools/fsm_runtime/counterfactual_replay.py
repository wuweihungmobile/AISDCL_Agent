...
def write_report(patch: PatchProposal, report: ReplayReport, *,
    ...
    # R44: patch.ac_id shares the same externally-influenceable provenance as
    # spec_patch_proposer's ac_id (defect-recycling signal) — sanitize before
    # path assembly (report title text keeps the raw value).
