...
class HubSyncClient:
    ...
    def diff(self, rule_id: str, endpoint_id: Optional[str] = None) -> DiffResult:
        # Path traversal defence: rule_id is externally-controlled (CLI positional
        # arg / direct API call). Sanitize before it is used to build any path so
        # a value like "../../secret_dir/leak" cannot escape cache_dir/REPO_ROOT.
