...
class GreenfieldSmokeTest(unittest.TestCase):
    ...
    def setUp(self) -> None:
        ...
        # v0.22 預設 AUTO_RECOVERY=ON（improving_57 B 軌常態化）；本 smoke 驗各錯誤分支之
        # retry→escalation 轉態，顯式 opt-out 隔離（auto-recovery 常態化由 test_auto_recovery_
        # wiring.DefaultOnNormalizationTests 專責覆蓋）。
