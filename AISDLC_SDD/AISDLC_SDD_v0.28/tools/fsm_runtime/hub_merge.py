...
def _write_conflict_report(
    ...
    *,
    ...
    # R44: rule_id is externally-controlled — sanitize before using it to
    # build a filesystem path (path traversal defence). Payload below keeps
    # the raw rule_id (display only).
