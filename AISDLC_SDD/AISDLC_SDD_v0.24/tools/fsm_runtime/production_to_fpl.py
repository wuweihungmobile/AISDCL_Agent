...
def generate_fpl_draft(
    ...
    *,
    ...
    # Path traversal defence: fpl_id / ac_id / divergence_kind are all
    # externally-controlled (R44 cross-platform review fix; see
    # state_loader.py _sanitize_component()) — both the explicit-override
    # branch and the fallback branch must be sanitized.
