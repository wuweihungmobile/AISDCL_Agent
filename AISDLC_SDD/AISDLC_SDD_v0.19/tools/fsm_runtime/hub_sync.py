...
class HubSyncClient:
    ...
    def diff(self, rule_id: str, endpoint_id: Optional[str] = None) -> DiffResult:
        ...
        # (CLI positional arg / direct API call). Sanitize before it flows
        # into cache_dir.rglob(...) / local_paths f-string joins below, or a
        # value like "../../secret_dir/leak" could escape the intended
        # directories (R44 cross-platform review fix; see state_loader.py
        # _sanitize_component()).
