...
| AUTOCLAUDE_DELEGATED | done：SDD→AutoClaude 委派執行完成，帶回 resume（ACT-172） | IMPLEMENTATION |
| AUTOCLAUDE_DELEGATED | failed：AutoClaude 側演化亦失敗/越閘 → 升級（ACT-172） | ESCALATION |
