...
def test_next_free_is_frontier():
    """next_free 為唯一分配前緣（Phase Z′ 落地 ACT-172 後：ACT-173 / R-9.39）。

    additive: ACT-172（improving_02 W1，AUTOCLAUDE_DELEGATED 觀察態落地）使前緣
    自 172 推進至 173；rule 前緣未取新號維持 9.39。
    """
    assert id_registry.next_act() == 173
