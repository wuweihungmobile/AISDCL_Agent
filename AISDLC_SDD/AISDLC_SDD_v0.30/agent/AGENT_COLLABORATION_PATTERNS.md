...
AISDLC-SDD 框架定義了 **5 種標準協作模式**，涵蓋不同的工作場景：
...
AISDLC-SDD 框架在原有的 5 種協作模式基礎上，新增了以 **SCG 閘門（Spec-First Gate）** 為驅動的協作規範。SCG 閘門不可跳過，每道閘門都有對應的 Agent 協作責任。
...
### v0.18 (2026-06-22)
- ✅ 隨框架 Copy-on-Evolve 升版至 v0.18（協作模式內容無實質變更）
- ✅ 標頭版本/適用範圍對齊框架 LATEST，並將內文敘述改為 version-agnostic，消除與同層 README（皆 v0.18）的版本漂移（DEF-AGTREV-021）
