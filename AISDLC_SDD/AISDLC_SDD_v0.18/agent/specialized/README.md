...
| `compliance-officer-zh.yaml` | 合規專員 | Security | GDPR/HIPAA/PCI-DSS 合規審查 |
...
| 檔案 | Agent 角色 | 觸發時機 |
|------|-----------|---------|
| `sdd-orchestrator-zh.yaml` | SDD 閉環總指揮 | 實作/PR 階段 Test→Fix 閉環 |
| `sdd-diagnostic-zh.yaml` | 自癒診斷 Agent | ESCALATION 觸發時 |
